...
SAUDI WORK-VISA QUESTION DETECTION
...
# ========================================================
#
# When the user explicitly selects Vaccination for
# Travelling Abroad, preserve that selection.
#
# This prevents the general router from accidentally
# changing the department for questions such as:
#
# "I am travelling to Saudi on work visa..."
# ========================================================
...
# ========================================================
#
# The researcher already contains these sources.
# This fallback protects against a search/verifier failure
# removing them before answer generation.
# ========================================================
...
# ========================================================
#
# These sources are explicitly marked official.
# If the normal verifier unexpectedly removes them,
# retain them for this narrowly defined case.
# ========================================================
...
# Work-visa questions have an explicit official evidence
# package even if the live search itself returns nothing.
if is_saudi_work_visa_question(
    question,
    selected_department,
):
